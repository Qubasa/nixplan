...
- FROM: `### Requirement: A configuration file whose bytes are a store path is shown from that path`
- TO: `### Requirement: A configuration file is shown at the record it states`
