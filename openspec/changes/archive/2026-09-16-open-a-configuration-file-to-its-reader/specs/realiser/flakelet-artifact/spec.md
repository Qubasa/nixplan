...
- FROM: `### Requirement: A host path this realiser cannot carry is refused`
- TO: `### Requirement: A host path this realiser can show is decided by its bytes and its record`
