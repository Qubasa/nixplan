...
| `plan` | 70 | keys, planes, absences, dependencies, serialisation, the golden fixture |
...
| `image` | 48 | the portable-service-image realiser's reading of an entry |
...
593 tests, counted as the test attributes of the files under `tests/unit/`. Both
